...
const CHARACTERS = [
  ...
  [3,"ピーテル",4,3,3,4,2,4,3,4,4,4,3,4], [4,"ウルタンド",3,4,3,3,4,3,3,4,3,3,4,3],
  [6,"ゲイツ",2,2,1,2,3,3,3,1,2,1,2,2],
  ...
  [11,"ファビオ",4,3,1,4,4,4,4,1,3,2,3,3],
  ...
  [26,"バッカニア",1,1,2,3,3,4,3,1,4,1,3,2], [27,"ムウ",1,1,4,1,1,4,1,2,3,2,1,3],
  [28,"オリンピア",3,2,3,1,2,2,3,3,2,4,2,2], [29,"タリムーン",4,4,2,4,4,4,4,2,4,2,4,4],
  [30,"ウーシュラ",1,2,3,1,1,3,1,2,3,1,2,3],
  ...
  [55,"アレキサンドラ",3,3,4,3,3,4,3,3,4,3,3,4],
